                    ...
                    Menus = new List<MenuItem>
                        {
                            ...
                            new MenuItem{MenuId = 104, ParentId = 1,Name = "流程及事项",Link = "/m/process/index",Class = "icon-03",Depth = 1,Role = ManagerRole.Package.GetValue(),Sort = 4},
                            new MenuItem{MenuId = 105, ParentId = 1,Name = "预约列表",Link = "/m/reservation/index",Class = "icon-03",Depth = 1,Role = ManagerRole.Reservation.GetValue(),Sort = 5},
                            new MenuItem{MenuId = 106, ParentId = 1,Name = "咨询交流",Link = "/m/consulting/index",Class = "icon-03",Depth = 1,Role = ManagerRole.Consulting.GetValue(),Sort = 6},
                            new MenuItem{MenuId = 107, ParentId = 1,Name = "图片专栏",Link = "/m/album/index",Class = "icon-03",Depth = 1,Role = ManagerRole.Overview.GetValue(),Sort = 7},
                            new MenuItem{MenuId = 108, ParentId = 1,Name = "疾病百科",Link = "/m/diseases/index",Class = "icon-03",Depth = 1,Role = ManagerRole.Diseases.GetValue(),Sort = 8},
